...
import me.cloud.pi.common.security.exception.PiOAuth2AuthencticationException;
...
public class PiBearerTokenResolver implements BearerTokenResolver {
    ...
    private void isExpired(String authorizationHeaderToken) {
        ...
        if (hasKey == null || !hasKey) {
            throw new PiOAuth2AuthencticationException(ResponseStatus.AUTHORIZATION_EXPIRED);
        }
    }
